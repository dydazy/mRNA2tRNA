...
def train_m2tRNA_with_length(m2tRNA_net, Learning_rate, epoch_num, batch_size, train_loader, test_loader,
							 codon_bias_length, pearson_correlation_loss,codon_usage,cds_length, trained_m2tRNA_Net_save_path):
	net1 = m2tRNA_net
	train_losses = []
	test_losses = []
